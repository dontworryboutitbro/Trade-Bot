...
const TRANSITIONS: Record<TradingMode, TradingMode[]> = {
  ...
  LIVE_MANUAL_PILOT: ["MOCK", "PAPER_MANUAL", "LIVE_LOCKED", "LIVE_MANUAL"],
  LIVE_MANUAL: ["MOCK", "PAPER_MANUAL", "LIVE_LOCKED", "LIVE_MANUAL_PILOT", "LIVE_AUTONOMOUS"],
...
export const LIVE_PILOT_CONFIRMATION_PHRASE = "ENABLE LIVE PILOT TRADING";

export function requiredPhraseFor(mode: TradingMode): string | null {
  if (mode === "LIVE_MANUAL_PILOT") return LIVE_PILOT_CONFIRMATION_PHRASE;
